class JFS {
    ...
    generateScrollObjects() {
        ...
        for(let i = 0; i < this.scrollElements.length; i++) {
            ...
            scrollObject.animation.easing = this.scrollElements[i].getAttribute('data-jfs-easing') ? this.scrollElements[i].getAttribute('data-jfs-easing') : "cubic-bezier(.13,.92,.37,1)";
